...
export async function setExpenseSheet(csvString, skipDirCheck) {
  ...
  await FileSystem.writeAsStringAsync(spreadsheetLocation, csvString, {encoding: FileSystem.EncodingType.UTF8});
}
...
export async function getExpenseSheet() {
  ...
  return await FileSystem.readAsStringAsync(spreadsheetLocation, {encoding: FileSystem.EncodingType.UTF8});
}
